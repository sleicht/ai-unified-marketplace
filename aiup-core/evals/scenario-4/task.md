...
1. **`docs/requirements.md`** — A minimal requirements document with the Mermaid use case diagram under `## Use Case Diagram`. Use the system name from `starter/package.json`.
