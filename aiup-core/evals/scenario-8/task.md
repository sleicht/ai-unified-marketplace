...
The product team has already produced the canonical catalogue and embedded Mermaid diagram in `docs/requirements.md`. What is missing is the full specification for **UC-001 Place Order**. This covers reviewing the cart, address, shipping, payment, confirmation, and meaningful failure paths.
...
The input file is `docs/requirements.md`; use the UC ID and exact name from its `Use Case Diagram` section.
