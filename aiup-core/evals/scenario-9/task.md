...
Your team has completed requirements for a new user account system. The signed-off catalogue and embedded Mermaid diagram are in `docs/requirements.md`, covering account registration and login.
...
Write complete use case specification documents for all use cases shown in the `Use Case Diagram` section of `docs/requirements.md`. Place the files in `docs/use_cases/`, one per use case.
